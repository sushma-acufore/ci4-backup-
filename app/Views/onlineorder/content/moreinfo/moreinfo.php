<?php 
include ( APPPATH . 'views/onlineorder/components/header.php' ); 
?>
<?php   
              ...
              <table class="table table-striped more-info-table" style="width:100%">
                <tbody>
                  ...
                  <tr >
                   ...
                   <td><div class="scrollBar"style="height:70px;overflow-y: scroll!important;background:#fff"><?php echo $ee['description']; ?></div></td>
                  ...
                  <tr >
                    <td>Price</td>
                    <td>$<?php echo number_format($ee['lprice'],2); ?><?php echo strtoupper($ee['curl']); ?></td>

                  </tr>

                  <tr>
                    <td>Dealer&nbsp;Discount</td>
                    <td><?php echo number_format($ee['sp_price'],2); ?><?php echo strtoupper($ee['curl']); ?></td>
                  </tr>

                  <?php 
                  if($ee['is_stock_dealer']==1){
                  ?>
                  <tr>
                    <td>*Stock&nbsp;Dealer&nbsp;Price</td>
                    <td>$<?php echo number_format($ee['totalprice'],2)." ".strtoupper($ee['curl']); ?></td>
                  </tr>
                  <?php 
                  }else{
                  ?>
                  <tr>
                    ...
                    <td>
                        ...
                        onclick="stock_dealer_alert('<?php echo $ee['pno']; ?>','<?php echo $ee['sp_price']; ?>','<?php echo $ee['stk_discount']; ?>','index')">Click&nbsp;Here</button>
                  ...
                  <tr>
                    ...
                    <td>$<?php echo number_format($ee['totalprice'],2); ?><?php echo strtoupper($ee['curl']); ?>
                    </td>
                  </tr>
                <?php 
                  $part_no=$ee['pno'];
                  ...
                  if($back==1){?>
                  <tr>
                    <td style="padding-left: 0px!important;"><button type="button" class="recomm_items_cancelbtn" 
                      onclick="cancle_btn_moreinfo('<?php echo $from_cart_icon ?>')">Back</button></td>
                    <td></td>
                  </tr>
                  <?php } ?>
                </tbody>
...
<!-- pop up -->
 ...
 <!-- Modal -->
 <div class="modal fade default_modals" id="price_alert_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content modal-box-design modal_style">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn popup-btn-okay popup-btn-yes" 
 ...
 <!--  Discount has not been setup correctly-->
 <div class="modal fade default_modals" id="invalid_discount_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content modal-box-design modal_style">
                ...
                <div class="modal-body">
                        <p id='par_id' style="text-align:center">Your Discount has not been setup correctly.<br>
                    Please contact Baumalight</p>
                </div>
