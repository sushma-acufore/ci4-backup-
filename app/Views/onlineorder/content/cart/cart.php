...
<!--
    ...
    <a href="index" id="add_product_top" style="display:none"><button style="cursor:pointer!important"class="your-cart-btn" type="button"
             ...
             <div class="col-md-12 new-addr-div" style="display:none">
                ...
                <div class="new-add-form-details">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-8" style="margin: 2px 0px;">
                          <input type="tel" class="form-control form-control-sm" name="new_addr_po_number" id="new_addr_po_number" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-8" style="margin: 2px 0px;">
                          <textarea class="form-control form-control-sm" name="note" id="note" required></textarea>
                          </div>
                      </div>
                    </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12" id="po_by_customer_div" style="display:none">
                  ...
                  <input class="form-control" id="po_by_customer" 
                  style="width:auto!important;border-radius:27px;padding: 0px 10px!important;" 
             ...
             <div class="shipp-address-buttons">
              <div class="col-md-12">
                <div style="margin-top: 30px;">
                  ...
                  <form method="post" action="<?php echo base_url(); ?>previeworder" id="myForm" style="float:right">
                    <button type="button" class="btn shipp-preview-btn" onclick="check_po_before_preview()">
                    Preview Order
                    </button>
                  </form>
